  ...
  <header class="flex items-center">
    ...
    <div class="flex ml-auto" v-else>
      <div class="dropdown inline-block relative z-10">
        <button
          class="bg-white text-gray-700 font-semibold py-4 px-6 rounded inline-flex item-center"
        >
          <img
        ...
        <ul
          class="dropdown-menu absolute hidden text-grey-700 pt-1 shadow w-full -mt-2"
        >
          <li>
            <nuxt-link
              to="/dashboard"
